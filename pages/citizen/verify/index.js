...
export default function PublicVerification() {
  ...
  const getStatusColor = (status) =>
    ({ verified: "success", pending: "warning", rejected: "error" }[status] ||
    "default");
  ...
  const onSearch = async (data) => {
    ...
    try {
      ...
      const found = (Array.isArray(properties) ? properties : []).find((p) => {
        ...
        const byTitle =
          normalize(p?.title).includes(q) || normalize(p?.name).includes(q);
        const byAddress =
    ...
    <CitizenLayout>
      ...
      >
        <Container maxWidth="md">
          <Paper
            elevation={3}
            sx={{ p: { xs: 2, md: 5 }, borderRadius: 5, mb: 5 }}
          >
            ...
            <Typography variant="body1" color="text.secondary" mb={3}>
              Verify property ownership and status. Use plot number, NFT token
              ID, or address.
            </Typography>
            <Box
              component="form"
            ...
            >
              ...
              <Tooltip title="Scan QR Code">
                <IconButton
                  onClick={() =>
                    enqueueSnackbar("QR scanning coming soon!", {
                      variant: "info",
                    })
                  }
                ...
                <Box sx={{ display: "flex", gap: 2 }}>
                  ...
                  <Tooltip title="Download Certificate">
                    <Button
                      ...
                      onClick={() =>
                        enqueueSnackbar("Downloading certificate...", {
                          variant: "success",
                        })
                      }
                    >
                            ...
                            <Grid xs={12} md={6}>
                              <List dense>
                                <ListItem>
                                  <ListItemText
                                    primary="Address"
                                    secondary={searchResult.location.address}
                                  />
                                </ListItem>
                                <ListItem>
                                  <ListItemText
                                ...
                                <ListItem>
                                  <ListItemText
                                    primary="Province"
                                    secondary={searchResult.location.province}
                                  />
                                </ListItem>
                              </List>
                            </Grid>
                              ...
                              <List dense>
                                <ListItem>
                                  <ListItemText
                                    primary="Coordinates"
                                    secondary={
                                      searchResult.location.coordinates
                                    }
                                  />
                                </ListItem>
                                <ListItem>
                      ...
                      <Card elevation={0}>
                        <CardContent>
                          ...
                          <Alert severity="info" sx={{ mb: 2 }}>
                            Owner info is partially hidden for privacy.
                          </Alert>
                          <Grid container spacing={2}>
                            <Grid xs={12} md={4}>
                              <Typography
                              ...
                              <Typography variant="body1" fontWeight={600}>
                                {searchResult.owner.name.substring(0, 1)}***{" "}
                                {searchResult.owner.name.split(" ").pop()}
                              </Typography>
                            </Grid>
                            <Grid xs={12} md={4}>
                              <Typography
                              ...
                              <Typography variant="body1" fontWeight={600}>
                                {searchResult.owner.nic.substring(0, 3)}***
                                {searchResult.owner.nic.substring(6)}
                              </Typography>
                            </Grid>
                            <Grid xs={12} md={4}>
                              <Typography
                              ...
                              <Typography variant="body1" fontWeight={600}>
                                {searchResult.owner.email.substring(0, 2)}***@
                                {searchResult.owner.email.split("@")[1]}
                              </Typography>
                            </Grid>
                          </Grid>
                        </CardContent>
                      ...
                      >
                        <CardContent>
                          ...
                          <Typography
                            ...
                            sx={{ opacity: 0.9, mb: 2 }}
                          >
                            This property is certified on the blockchain.
                          </Typography>
                          <Grid container spacing={2}>
                            <Grid xs={12} md={6}>
                ...
                <Grid xs={12} md={4}>
                  <Card elevation={0}>
                    <CardContent>
                      ...
                      <Divider sx={{ mb: 2 }} />
                      <List dense>
                        {searchResult.history.map((e, i) => (
                          <ListItem key={i}>
                            <ListItemText
                              primary={e.action}
                              secondary={`${e.date} • ${e.actor}`}
                            />
                          </ListItem>
                        ))}
                      </List>
