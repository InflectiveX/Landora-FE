        ...
        {menuItems.map((item) => (
          <ListItem
            ...
            sx={{
              ...
              py: 1.8,
              px: 2,
              bgcolor: pathname === item.path ? 'rgba(23,165,137,0.1)' : 'transparent',
              color: pathname === item.path ? '#17A589' : '#4A4A4A',
              position: 'relative',
              cursor: 'pointer',
              ...
              '&:hover': {
                bgcolor: pathname === item.path ? 'rgba(23,165,137,0.12)' : 'rgba(93,173,226,0.08)',
                color: pathname === item.path ? '#17A589' : '#5DADE2',
