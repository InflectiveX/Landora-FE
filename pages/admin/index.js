...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const properties = await apiClient.property
          .getDetails()
          .catch((error) => {
    ...
    <OfficerLayout>
      <Box>
        ...
        >
          ...
          <Box>
            <Button color="primary" startIcon={<RefreshIcon />}>
              Refresh
            </Button>
            <Button
              variant="outlined"
              ...
              <Card>
                <CardContent>
                  ...
                  >
                    ...
                    <Avatar
                      sx={{ bgcolor: `${s.color}.main`, width: 56, height: 56 }}
                    >
                      {s.icon}
                    </Avatar>
                  </Box>
                    ...
                    <ListItem>
                      ...
                      <ListItemText
                        primary={
                          ...
                          >
                            <Typography variant="body1">{a.action}</Typography>
                            <Typography variant="caption" sx={{ opacity: 0.8 }}>
                              {a.property}
                            </Typography>
                          </Box>
                        }
                        secondary={`By ${a.officer} • ${a.timestamp}`}
                      />
                    </ListItem>
